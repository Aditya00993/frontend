...
export default function Home({isRelogin = false}: HomeProps) {
  ...
  return (
    <main className="flex min-h-screen flex-col">
      <div className="bg-[#030F5B] flex h-20 shrink-0 items-end rounded-lg bg-primary-500 color-primary p-4 md:h-52">
        <div className="flex flex-row items-center leading-none text-danger">
        <img src="logo.png" width="140px" height="80px" />
          <p className="text-[44px] mt-4 ml-3 text-white">DR CBS Audit Reporting System <br></br>
          <p className="text-[20px] text-danger ml-2 mt-2">CERT- In Empanelled Information Security Auditing Organization</p>
            </p> 
