              ...
              <TabPanel value="summary">
                ...
                <div className='w-2/3'>
                  <div className="w-full mb-4">
                    ...
                    <div className="relative cursor-text dark:text-white">{project.audit_organisation_name}</div>
                  </div>
                  ...
                  <div className="w-full mb-4">
                    <label className={StyleLabel}>Auditor</label>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative cursor-text dark:text-white">{project.contact_person_name}</div>
                  </div>
                  <div className="mt-4">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative cursor-text dark:text-white">{project.audit_type}</div>
                  </div>
                  <div className="mt-4">
                    <label className={StyleLabel}>Project Expected Outcomes</label>
                    <div>
                    <CKWrapper
                    id="description"
