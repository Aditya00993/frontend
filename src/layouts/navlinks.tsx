...
const NavLinks: React.FC<NavLinksProps> = ({ theme, toggleTheme }) => {
  ...
  const links = [
    ...
    { name: 'Organisation', href: '/companies', icon: BuildingOfficeIcon },
    
    { name: 'Audits', href: '/projects', icon: RocketLaunchIcon },
    //{ name: 'Work Order', href: '/workorder', icon: BuildingOfficeIcon },
